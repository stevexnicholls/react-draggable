  ...
  /*: DraggableProps*/
    ...
    _defineProperty(_assertThisInitialized(_this), "onDrag", function (e, coreData) {
      ...
      if (_this.props.bounds) {
        ...
        var _getBoundPosition2 = (0, _positionFns.getBoundPosition)(_assertThisInitialized(_this), newState.x, newState.y),
            _getBoundPosition3 = _slicedToArray(_getBoundPosition2, 2),
            newStateX = _getBoundPosition3[0],
            newStateY = _getBoundPosition3[1];
