...
var Draggable = /*#__PURE__*/function (_React$Component) {
  ...
  /*: DraggableProps*/
    ...
    Draggable_defineProperty(Draggable_assertThisInitialized(_this), "filter", memoizeOne(function (triggerBounds) {
      var _getBoundPosition = getBoundPosition(Draggable_assertThisInitialized(_this), _this.state.x, _this.state.y),
          newStateX = _getBoundPosition[0],
          newStateY = _getBoundPosition[1];
    ...
    Draggable_defineProperty(Draggable_assertThisInitialized(_this), "onDrag", function (e, coreData) {
      ...
      if (_this.props.bounds) {
        ...
        var _getBoundPosition2 = getBoundPosition(Draggable_assertThisInitialized(_this), newState.x, newState.y),
            _getBoundPosition3 = Draggable_slicedToArray(_getBoundPosition2, 2),
